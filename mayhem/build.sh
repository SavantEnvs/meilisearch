...
# 1.91.1, which would hijack every BARE `cargo` in the tree (and stable can't do
...
# every cargo invocation so the upstream root rust-toolchain.toml (stable 1.91.1)
